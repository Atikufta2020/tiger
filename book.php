        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="user_option">
              ...
              <a href="order.html" class="order_online">
                Order Online
              </a>
            </div>
          </div>
        ...
        <div class="col-md-6">
          <div class="form_container">
            <form action="config.php" method="post">
              ...
              <div>
                <input type="text" class="form-control" required placeholder="Food Name" name="food_name" />
              </div>
              <div>
              ...
              <div>
                <input type="phone" class="form-control" required placeholder="Your Phone" name="phone"/>
              </div> 
              <div>
                <input type="number" class="form-control" required placeholder="Enter amount in local currency" name="amount"/>
              </div>   
      ...
      <div class="row">
        <div class="col-md-4 footer-col">
          <div class="footer_contact">
            ...
            <div class="contact_link_box">
              ...
              <a href="mailto: foodspicy72@gmail.com">
                <i class="fa fa-envelope" aria-hidden="true"></i>
                <span>
                  foodspicy72@gmail.com
                </span>
              </a>
            </div>
          </div>
        ...
        <div class="col-md-4 footer-col">
          <div class="footer_detail">
            ...
            <p>
              sPiCe72 sources it's ingredient 100% from our local farmers at their freshiest form. 
            </p>
